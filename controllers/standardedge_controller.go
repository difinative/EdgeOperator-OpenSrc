...
type StandardEdgeReconciler struct {
	client.Client
	Scheme *runtime.Scheme
}

//+kubebuilder:rbac:groups=operator.difinative,resources=standardedges,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=operator.difinative,resources=standardedges/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=operator.difinative,resources=standardedges/finalizers,verbs=update

// Reconcile is part of the main kubernetes reconciliation loop which aims to
// move the current state of the cluster closer to the desired state.
// TODO(user): Modify the Reconcile function to compare the state specified by
// the StandardEdge object against the actual cluster state, and then
